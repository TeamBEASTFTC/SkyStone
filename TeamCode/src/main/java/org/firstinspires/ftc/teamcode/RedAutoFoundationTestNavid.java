...
//        choppy.shuffle(0.5, 500, !blueAlliance);
        choppy.moveForwBackEncoder(0.75, 8,true, !blueAlliance);
        choppy.rotateEncoder(0.5, 400,false, false);
        choppy.moveForwBackEncoder(0.75, 2, true,true);
        choppy.releaseCapstone();
        // moving to drop capstone
        choppy.moveForwBackEncoder(0.75,14,true,false);
        choppy.rotateEncoder(0.75,400,false,false);
        ...
        //move the foundation
        choppy.moveForwBackEncoder(0.75,6,true,false);
        choppy.rotateEncoder(0.75,400,false,false);
