...
//        choppy.shuffle(0.5, 500, !blueAlliance);
        ...
        choppy.moveForwBackEncoder(0.75,35,true,false);
        choppy.rotateEncoder(0.5,400,false,false);
